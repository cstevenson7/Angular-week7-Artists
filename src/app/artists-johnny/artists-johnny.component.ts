...
@Component({
  selector: 'app-artists-johnny',
  templateUrl: './artists-johnny.component.html',
  styleUrls: ['./artists-johnny.component.scss']
})
export class ArtistsJohnnyComponent implements OnInit {
  artistsDobDisplay;
  artistsSongDisplay;
  artistsGenreDisplay;
